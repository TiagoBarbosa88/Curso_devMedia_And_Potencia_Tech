...
function selecionarQuestoesAleatorias(questoes, quantidadeQuestoes) { // Função que retorna 10 perguntas aleatorias
  ...
  return questoesAleatorias.slice(0, quantidadeQuestoes); // retorna um novo array com 10 perguntas aleatórias
}

function selecionarQuestoesAleatorias(questoes, quantidadeQuestoes) {
  return questoes.sort(() => Math.random() - 0.5).slice(0, quantidadeQuestoes);  // Embaralha as perguntas do array questoes
}
